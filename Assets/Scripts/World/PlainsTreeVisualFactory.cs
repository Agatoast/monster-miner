    ...
    public static class PlainsTreeVisualFactory
    {
            ...
            float sizeScale = 1f)
        {
            ...
            for (int i = 0; i < treeCount; i++)
            {
                ...
                float offsetDistance = Random.Range(0.4f, 3.2f) * Mathf.Max(1f, sizeScale);
                ...
                CreateTree(copse, offset, seed * 17 + i, localCenter, sampleGroundY, sizeScale);
            }
        }
            ...
            float sizeScale = 1f)
        {
            ...
            float scale = Mathf.Max(0.6f, sizeScale);
            ...
            float trunkHeight = Random.Range(1.8f, 3.1f) * scale;
            float trunkRadius = Random.Range(0.14f, 0.24f) * scale;
            float foliageScale = Random.Range(1.4f, 2.4f) * scale;
